...
{
    /// <summary>
    /// V010 — Roof creation for footprint roofs from linked-room boundaries.
    /// Migrated from FootprintRoofFromLines's proven RoofCreationService pattern
    /// to fix earlier roof-creation failures in this tool.
    ...
    /// Signature: IList&lt;Curve&gt; + ElementId roofTypeId (resolved to RoofType
    /// internally), plus a log callback.
    /// </summary>
