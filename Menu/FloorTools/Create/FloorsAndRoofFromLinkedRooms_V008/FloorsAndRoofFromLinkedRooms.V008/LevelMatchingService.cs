...
namespace Revit26_Plugin.FloorsAndRoofFromLinkedRooms.V008
{
    ...
    /// room's level against them by ELEVATION (V007 — replaces the V001-V006 name-based
    ...
    public static class LevelMatchingService
    {
        ...
        /// <summary>
        /// V007: elevation-based match. The linked room's level elevation (in the linked
