...
namespace Revit26_Plugin.FloorsAndRoofFromLinkedRooms.V008
{
    ...
    public partial class RoomCandidate : ObservableObject
    {
        ...
        /// <summary>V007: raw elevation of the room's Level, in the LINKED document's own
        /// coordinate space (internal units/feet), before the link placement transform is
        /// applied. Null when the room has no Level — LevelMatchingService.FindMatch treats
        /// null as unmatchable (room stays unmapped).</summary>
        public double? LinkedLevelElevation { get; set; }
