...
{
    /// <summary>
    /// ASSUMPTION (flagged, carried from V003): the GUID list below is a starting point
    /// copied from similar slab/floor-creation tools in the suite. Confirm the actual
    /// warning GUIDs you see during testing on a real model before relying on this — wrong
    /// GUIDs mean warnings you actually want to see could get silently deleted.
    /// </summary>
