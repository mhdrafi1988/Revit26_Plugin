namespace Revit26_Plugin.LinkedDetailLineGenerator.VA007.Core.Models
{
    ...
    /// <summary>VA007 Links panel status filter chips. Loaded/NeedsReview map to
    /// RevitLinkType.GetLinkedFileStatus()'s Loaded/CanBeUpgraded — the only two
    /// statuses LinkService ever surfaces (everything else is excluded entirely).</summary>
    ...
    /// <summary>VA007 Links panel sort modes.</summary>
    public enum LinkSortMode
    {
        Name,
        Status
    }
