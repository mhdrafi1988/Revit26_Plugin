...
namespace Revit26_Plugin.AutoSlopeByPoint.V016.Core.Models
{
    public class AutoSlopePayload
    {
        ...
        /// <summary>
        /// Global choice for how 3+ arcs in a single path are combined:
        /// Sequential (arc-by-arc, chained bitangents) or PairwiseCombination
        /// (all-pairs bitangents, Dijkstra picks the combination). Applies to
        /// every vertex in this run.
        /// </summary>
        public MultiArcMode MultiArcMode { get; set; } = MultiArcMode.Sequential;
