...
namespace Revit26_Plugin.AutoSlopeByPoint.V016.Core.Models
{
    public class VertexData
    {
        ...
        // ── Staged pipeline reporting (V016) ────────────────────────────
        // Which stage produced the winning path: "Direct", "Graph", or "ArcTangent".
        public string PathMethod { get; set; } = "";

        // Populated only when PathMethod == "ArcTangent" — e.g. "Convex (single arc)"
        // or "Convex x2 (Sequential)" / "Convex x3 (PairwiseCombination)".
        public string ArcTypeSummary { get; set; } = "";
