...
// Namespace: Revit26_Plugin.AutoSlopeByPoint.V017
// Changes vs V06:
...
using Revit26_Plugin.AutoSlopeByPoint.V017.Core.Models;
using Revit26_Plugin.AutoSlopeByPoint.V017.Core.Parameters;
using Revit26_Plugin.AutoSlopeByPoint.V017.Infrastructure.Helpers;
...
namespace Revit26_Plugin.AutoSlopeByPoint.V017.Core.Engine
{
        ...
        public static void Execute(UIApplication app, AutoSlopePayload data)
        {
            ...
            if (data.ExportConfig?.ExportToExcel == true)
            {
                compactPath = ExcelExportService.ExportCompactVertexData(
                    ...
                    data.PickedDrainPoints?.Count ?? 0, finalDrainPoints.Count,
                    highest_mm, longest_m, durationSec);
