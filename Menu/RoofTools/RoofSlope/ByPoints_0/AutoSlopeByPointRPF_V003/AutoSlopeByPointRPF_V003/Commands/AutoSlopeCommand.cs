...
using Revit26_Plugin.AutoSlopeByPointRPF.V003.UI.Views;
using System;
using System.Collections.Generic;

namespace Revit26_Plugin.AutoSlopeByPointRPF.V003.Commands
{
    ...
    public class AutoSlopeCommand : IExternalCommand
    {
        public Result Execute(ExternalCommandData data, ref string msg, ElementSet elems)
        {
            ...
            using (TransactionGroup tg = new TransactionGroup(doc, "AutoSlope Setup"))
            {
                ...
                var win = new AutoSlopeByPointRPFWindow(uidoc, data.Application, roof.Id, drains);
                win.Show();
            }
