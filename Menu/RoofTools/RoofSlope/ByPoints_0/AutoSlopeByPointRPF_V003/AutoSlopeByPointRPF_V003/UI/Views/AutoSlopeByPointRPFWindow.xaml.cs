// =======================================================
// File: AutoSlopeByPointRPFWindow.xaml.cs
// Fixes:
...
using Revit26_Plugin.AutoSlopeByPointRPF.V003.UI.ViewModels;   // ensure ViewModel namespace matches
...
namespace Revit26_Plugin.AutoSlopeByPointRPF.V003.UI.Views      // ✅ changed from _04 to _041
{
    public partial class AutoSlopeByPointRPFWindow : Window
    {
        public AutoSlopeByPointRPFWindow(
            UIDocument uidoc,
            UIApplication app,
            ElementId roofId,
            List<XYZ> drains)
