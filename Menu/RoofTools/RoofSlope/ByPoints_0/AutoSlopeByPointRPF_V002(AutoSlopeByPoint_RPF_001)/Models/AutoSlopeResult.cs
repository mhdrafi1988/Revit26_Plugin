...
namespace Revit26_Plugin.AutoSlopeByPointRPF.V002.RPF_001.Core.Models
{
    public class AutoSlopeResult
    {
        ...
        /// <summary>Total roof vertices matched as ridge points across all pairwise ridge lines and junctions. 0 if EnableRidgePoints was false or nothing matched.</summary>
        public int TotalRidgePointsFound { get; set; }
    }
}