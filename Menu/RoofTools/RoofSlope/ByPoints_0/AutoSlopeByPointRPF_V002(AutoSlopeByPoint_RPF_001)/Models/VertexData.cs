...
namespace Revit26_Plugin.AutoSlopeByPointRPF.V002.RPF_001.Core.Models
{
    public class VertexData
    {
        ...
        /// <summary>True if this vertex's elevation was set by Ridge Point Detection's FartherGroup rule instead of the standard single-source path × slope formula. New in RPF_001.</summary>
