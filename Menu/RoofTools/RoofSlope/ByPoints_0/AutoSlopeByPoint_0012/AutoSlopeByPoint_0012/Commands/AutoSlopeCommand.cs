...
using Revit26_Plugin.AutoSlopeByPoint.V012.UI.Views;
using System;
using System.Collections.Generic;

namespace Revit26_Plugin.AutoSlopeByPoint.V012.Commands
{
    ...
    public class AutoSlopeCommand : IExternalCommand
    {
        public Result Execute(ExternalCommandData data, ref string msg, ElementSet elems)
        {
            ...
            using (TransactionGroup tg = new TransactionGroup(doc, "AutoSlope Setup"))
            {
                ...
                // FIX: without an explicit owner, the window is not parented to
                // Revit's main window and can drop behind it once Revit regains
                // focus (e.g. during the Regenerate() call triggered by the
                // curve intersection feature). Never use Application.Current.MainWindow.
