...
//       shown in the UI.
// Standardized (2026-09): restored to owning its own Transaction,
// matching every other AutoSlope tool. This requires the caller
// (MultiSlopeVariantEngine.ProcessRow) to invoke WriteAll only AFTER
// its own per-copy geometry Transaction has committed — see that
// file's header comment for the updated transaction structure.
// =======================================================
...
namespace Revit26_Plugin.AutoSlopeByPoint.MultiCopies28.Core.Parameters
{
