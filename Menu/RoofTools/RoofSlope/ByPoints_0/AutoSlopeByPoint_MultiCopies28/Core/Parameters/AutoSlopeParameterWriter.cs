...
//       shown in the UI.
// Changes vs V028:
//   - No longer opens its own Transaction — called from within
//     AutoSlopeEngine.ApplySlope, which itself runs inside the
//     caller's (MultiSlopeVariantEngine's) already-open SubTransaction
//     for this roof copy.
// =======================================================
