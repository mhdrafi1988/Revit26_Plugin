...
namespace Revit26_Plugin.AutoSlopeByPoint.MultiCopies28.UI.ViewModels
{
    public partial class AutoSlopeViewModel : ObservableObject
    {
        ...
        private void CancelRun()
        {
            ...
            AddLog(new LogEntry(LogLevel.Warning, "Cancel requested — finishing the current slope's in-progress work, then stopping."));
        }
            ...
            AutoSlopeHandler.Payload = new MultiSlopePayload
            {
                ...
                OnCompleted = summary =>
                {
                    Application.Current.Dispatcher.BeginInvoke(new Action(() =>
                    {
                        ...
                        // though some rows succeeded — the Run button does not get
