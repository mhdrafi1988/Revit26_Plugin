namespace Revit26_Plugin.AutoSlopeByPoint.MultiCopies28.Infrastructure.Helpers
{
    public static class AppConstants
    {
        ...
        public const int    DefaultThresholdMeters = 100;
        public const int    DefaultDrainToleranceMm = 500;
        public const string DefaultExportFolder    = "AutoSlope_Reports";

        /// <summary>Format string for each slope variant's workset name — one placeholder for the slope value, e.g. "Roof_Slope_2%".</summary>
        public const string WorksetNameFormat = "Roof_Slope_{0}%";
