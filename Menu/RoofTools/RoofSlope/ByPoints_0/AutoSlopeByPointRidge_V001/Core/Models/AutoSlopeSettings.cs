...
//          %AppData%\Revit26_Plugin\AutoSlopeByPointRidge\settings.json
...
namespace Revit26_Plugin.AutoSlopeByPointRidge.V001.Core.Models
{
    ...
    public class AutoSlopeSettings
    {
        ...
        // ── Ridge (new in Ridge V001) ────────────────────────────────────
        public bool RidgeDetectionEnabled { get; set; } = true;
        public int DrainGroupRadiusMm { get; set; } = 1000;
        public CircleMarkerGroupSettings RidgeMarkerGroup { get; set; } = new CircleMarkerGroupSettings();
