...
// Ported unchanged from AutoSlopeByPoint / AutoSlopeByDrain V004. This file
// existed in V004 but was never actually called anywhere (dead code) — it is
// now wired into AutoSlopeDrainEngine via the "Insert intersection points on
// curves" toggle, per Rafi's confirmed decision (opt-in, off by default).
//
// Purpose:
