...
using Revit26_Plugin.MultiRoofSlopeByDrain.V009.Core.Parameters;
using Revit26_Plugin.MultiRoofSlopeByDrain.V009.Core.Services;
using Revit26_Plugin.MultiRoofSlopeByDrain.V009.Infrastructure.Helpers;
using Revit26_Plugin.Shared.Models;
using System;
using System.Collections.Generic;
using System.Linq;

namespace Revit26_Plugin.MultiRoofSlopeByDrain.V009.Core.Engine
{
    public static class AutoSlopeDrainEngine
    {
        private const string ToolVersion = "008";
