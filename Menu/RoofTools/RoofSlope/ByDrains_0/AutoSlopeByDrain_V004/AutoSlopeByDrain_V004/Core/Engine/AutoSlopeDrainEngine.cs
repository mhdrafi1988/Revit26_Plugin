...
// DrainDetectionService (drain identification) remains UNCHANGED from the
// CSV version. RoofSlopeProcessorService's path-solving internals were
// UPDATED in V004 to use DijkstraPathEngine (straight-line primary,
// tangent-arc fallback, ported from AutoSlopeByPoint) in place of the old
// straight-line-only GraphBuilderService/PathSolverService pair.

using Autodesk.Revit.DB;
using Autodesk.Revit.UI;
using Revit26_Plugin.AutoSlopeByDrain.V004.Core.Models;
using Revit26_Plugin.AutoSlopeByDrain.V004.Core.Parameters;
    ...
    public static class AutoSlopeDrainEngine
    {
        public static AutoSlopeDrainResult Execute(UIApplication app, AutoSlopeDrainPayload payload)
        {
            ...
            try
            {
                ...
                var detectedDrains = detectionService.DetectDrainsFromRoof(roof, topFace, roofData.Vertices, log);
