...
namespace Revit26_Plugin.MultiRoofSlopeByDrain.V010.Core.Models
{
    public class AutoSlopeDrainResult
    {
        ...
        /// <summary>NEW (V010). True when this roof's run was stopped by the user's Cancel button, as distinct from a genuine failure. Success is also false in this case.</summary>
        ...
        /// <summary>Wall-clock time this roof's run started, e.g. "14:32:05".</summary>
        public string StartTime { get; set; }

        /// <summary>Wall-clock time this roof's run finished, e.g. "14:32:41".</summary>
        ...
        /// <summary>Circles placed on selected drain openings. 0 if the marker group was disabled or the active view wasn't a plan view.</summary>
