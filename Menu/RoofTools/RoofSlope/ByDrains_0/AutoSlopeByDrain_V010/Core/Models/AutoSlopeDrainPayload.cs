...
namespace Revit26_Plugin.MultiRoofSlopeByDrain.V010.Core.Models
{
    public class AutoSlopeDrainPayload
    {
        ...
        /// <summary>NEW (V008). Roof name, captured at payload build time — used to label this roof's row in the combined summary workbook and in AutoSlopeDrainRoofResult.</summary>
        ...
        /// <summary>Style/config for circles placed on selected drain openings. Ported from AutoSlopeByPoint's Circle Markers.</summary>
        ...
        /// <summary>
        /// NEW (V010). Called at phase boundaries and, throttled, during
        ...
        /// <summary>
        /// NEW (V010). Shared across every roof in the batch (one CancellationTokenSource
