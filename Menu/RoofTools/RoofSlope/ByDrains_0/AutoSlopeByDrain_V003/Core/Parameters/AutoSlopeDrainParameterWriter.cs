...
// Location: Revit26_Plugin.AutoSlopeByDrain.V003.Core.Parameters
...
namespace Revit26_Plugin.AutoSlopeByDrain.V003.Core.Parameters
{
            ...
            Action<string> logAction = null)
        {
            ...
            using (Transaction tx = new Transaction(doc, "AutoSlope – Update Roof Parameters"))
            {
                ...
                TrySetString(roof, AppConstants.Param_Versions,
                    "V003", // or your current version number
                    ref successCount, ref failCount);
