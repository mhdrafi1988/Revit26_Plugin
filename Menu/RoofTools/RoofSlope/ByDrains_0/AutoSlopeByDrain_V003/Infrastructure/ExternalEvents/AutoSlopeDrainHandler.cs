...
// Mirrors AutoSlopeByPoint's AutoSlopeHandler.

using Autodesk.Revit.DB;
using Autodesk.Revit.UI;
using Revit26_Plugin.AutoSlopeByDrain.V003.Core.Engine;
using Revit26_Plugin.AutoSlopeByDrain.V003.Core.Models;
using Revit26_Plugin.Shared.Models;
using System;

namespace Revit26_Plugin.AutoSlopeByDrain.V003.Infrastructure.ExternalEvents
{
