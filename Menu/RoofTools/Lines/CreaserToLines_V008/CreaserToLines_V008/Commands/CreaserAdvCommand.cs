...
using Revit26_Plugin.CreaserAdv_V008.Services.Logging;
using Revit26_Plugin.CreaserAdv_V008.ViewModels;
using Revit26_Plugin.CreaserAdv_V008.Views;
using System;

namespace Revit26_Plugin.CreaserAdv_V008.Commands
{
    ...
    public class CreaserAdvCommand : IExternalCommand
    {
            ...
            ElementSet elements)
        {
            try
            {
                ...
                {
                    roof =
                        new Revit26_Plugin.CreaserAdv_V008.Services.Selection.RoofSelectionService()
