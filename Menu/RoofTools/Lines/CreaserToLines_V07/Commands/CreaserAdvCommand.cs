...
using Revit26_Plugin.CreaserAdv_V00_701.ViewModels;
using Revit26_Plugin.CreaserAdv_V00_701.Views;
using System;

namespace Revit26_Plugin.CreaserAdv_V00_701.Commands
{
    ...
    public class CreaserAdvCommand : IExternalCommand
    {
            ...
            ElementSet elements)
        {
            try
            {
                ...
                {
                    roof =
                        new Revit26_Plugin.CreaserAdv_V00_701.Services.Selection.RoofSelectionService()
