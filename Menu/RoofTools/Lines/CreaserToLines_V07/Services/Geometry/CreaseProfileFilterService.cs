...
{
    /// <summary>
    /// Removes creases that overlap roof profile (outer or inner boundaries).
    /// Uses colinearity + interval overlap.
    /// </summary>
    public class CreaseProfileFilterService
    {
            ...
            IList<Line> profileLines2d)
        {
            ...
            _log.Info(
                $"Creases after profile filtering: {result.Count}/{creaseLines2d.Count}");
