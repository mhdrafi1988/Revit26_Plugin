...
using Revit26_Plugin.CreaserAdv_V007_00.ViewModels;
using Revit26_Plugin.CreaserAdv_V007_00.Views;
using System;

namespace Revit26_Plugin.CreaserAdv_V007_00.Commands
{
    ...
    public class CreaserAdvCommand : IExternalCommand
    {
            ...
            ElementSet          elements)
        {
            try
            {
                ...
                logger.Info("Creaser Advanced V007_00 started.");
