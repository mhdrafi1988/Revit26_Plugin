...
using Revit26_Plugin.CreaserAdv_V002_01.Services;

namespace Revit26_Plugin.CreaserAdv_V002_01.ViewModels
{
    /// <summary>
    ...
    public partial class CreaserAdvViewModel : ObservableObject
    {
        ...
        private void Run()
        {
                   ...
                   new Transaction(_doc, "Creaser Advanced – Place Creases"))
            {
                ...
                var creaseLines3d = new List<Line>();
                foreach (var curve in creaseCurves3d)
                {
                    if (curve is Line line)
                        creaseLines3d.Add(line);
                }
