...
using Revit26_Plugin.RoofTools.LineAndPoints.RoofRidgeLines_V51.Views;

namespace Revit26_Plugin.RoofTools.LineAndPoints.RoofRidgeLines_V51.Commands
{
    ...
    public class RoofRidgeCommand : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            try
            {
                ...
                // ── 2. Select Drain Points on that roof ─────────────────────────
                ...
                {
                    message = "At least two drain points are required to generate ridges.";
                    return Result.Failed;
                }

                // ── 3. Create ViewModel with pre‑selected data ──────────────────
