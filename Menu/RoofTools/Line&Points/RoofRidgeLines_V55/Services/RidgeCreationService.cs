...
namespace Revit26_Plugin.RoofTools.LineAndPoints.RoofRidgeLines.V55.Services
{
    public class RidgeCreationService
    {
            ...
            VoronoiRidgeResult result)
        {
            ...
            // TX-3: Detail lines — now runs FIRST. Built only from
            // result.ClippedEdges, so it has no dependency on the slab shape
            // editor / TX-0-TX-1-TX-2 model update that follows.
            ...
            if (!EnableShapeEditing(doc, roof))
            {
                ...
                System.Diagnostics.Debug.WriteLine(
                    ...
                    "unavailable. Detail lines were created in TX-3 regardless.");
                return;
            }
        ...
        // ── TX-3: Detail lines (now executed FIRST in CreateAll, before TX-0) ──────
