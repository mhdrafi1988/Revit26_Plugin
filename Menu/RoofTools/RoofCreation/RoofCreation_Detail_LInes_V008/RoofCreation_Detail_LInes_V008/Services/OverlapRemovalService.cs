...
namespace Revit26_Plugin.RoofFromFloor.V008.Services
{
    public static class OverlapRemovalService
    {
        ...
        /// <summary>
        /// Two arcs overlap when they share the same center, radius, and Z plane,
        /// and their angular spans intersect.
        /// </summary>
        private static bool AreArcsOverlapping(Arc a, Arc b)
        {
            ...
            // Angular spans must overlap (both arcs on the same circle)
