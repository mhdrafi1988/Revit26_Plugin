...
namespace Revit26_Plugin.RoofFromDetailLines.V007
{
    ...
    /// %AppData%\Revit26_Plugin\RoofFromDetailLines\settings.json.
    /// All failures are non-fatal: a corrupt or missing file yields fresh defaults,
    /// and a failed save is reported back via the out message for the UI log.
    /// </summary>
    public static class SettingsService
    {
        private static readonly string Folder = Path.Combine(
            Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData),
            "Revit26_Plugin", "RoofFromDetailLines");
