...
using Revit26_Plugin.RoofEdgeVertexReducer.V001.Commands;
using Revit26_Plugin.RoofEdgeVertexReducer.V001.Models;
using Revit26_Plugin.RoofEdgeVertexReducer.V001.Services;
using Revit26_Plugin.Shared.Models;

namespace Revit26_Plugin.RoofEdgeVertexReducer.V001.ViewModels
{
    public partial class MainViewModel : ObservableObject
    {
        ...
        private static string ActionColorKey(VertexDecision d) =>
            ...
            d.Action == VertexAction.KeepMaxZ ? "Success" : "Secondary";
