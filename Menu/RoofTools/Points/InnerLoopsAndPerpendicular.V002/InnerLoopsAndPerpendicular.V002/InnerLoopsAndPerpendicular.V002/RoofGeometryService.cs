...
using Revit26_Plugin.DivideInnerLoopsAndPerpendicular.V002.Models;
using System;
using System.Collections.Generic;
using System.Linq;

namespace Revit26_Plugin.DivideInnerLoopsAndPerpendicular.V002.Services
{
    /// <summary>
    /// Extracts boundary loops from a roof and classifies them by shape
    /// (Circular, Rectangular, Other).
    /// </summary>
    public class RoofGeometryService
    {
        /// <summary>
        /// Extracts all boundary loops from the given roof, classifies them
        /// by shape, and returns them as a list of <see cref="RoofLoopModel"/>.
        /// </summary>
        /// <param name="roof">The roof from which to extract loops.</param>
        /// <returns>A list of <see cref="RoofLoopModel"/> representing the roof's boundaries.</returns>
        ...
        /// <summary>
        /// Classifies a curve loop as Circular, Rectangular, or Other based on
        /// its geometry.
        /// </summary>
        /// <param name="loop">The curve loop to classify.</param>
        /// <param name="center">Output: The center point if circular, otherwise zero.</param>
        /// <param name="radius">Output: The radius if circular, otherwise zero.</param>
        /// <returns>The shape type: "Circular", "Rectangle", or "Other".</returns>
