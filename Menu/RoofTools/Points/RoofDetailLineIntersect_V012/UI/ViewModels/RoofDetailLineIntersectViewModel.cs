...
using Revit26_Plugin.RoofDetailLineIntersect.V012.Infrastructure.ExternalEvents;
...
namespace Revit26_Plugin.RoofDetailLineIntersect.V012.UI.ViewModels
{
    public partial class RoofDetailLineIntersectViewModel : ObservableObject
    {
        ...
        [ObservableProperty] private int    lineToLineIntersectionsFound;
        ...
        private void Run()
        {
            ...
            LineToLineIntersectionsFound = 0;
            PointsPlaced                 = 0;
            SkippedCount                 = 0;
            ...
            RoofDetailLineIntersectHandler.Payload = new RoofDetailLineIntersectPayload
            {
                ...
                IncludeLineToLineIntersections = IncludeLineToLineIntersections,
                Log                            = AddLog,
                OnCompleted                    = result =>
                {
                    Application.Current.Dispatcher.BeginInvoke(new Action(() =>
                    {
                        ...
                        LineToLineIntersectionsFound = result.LineToLineIntersectionsFound;
