...
using Revit26_Plugin.RoofDetailLineIntersect.V011.Infrastructure.Helpers;
using Revit26_Plugin.RoofDetailLineIntersect.V011.UI.ViewModels;
using Revit26_Plugin.RoofDetailLineIntersect.V011.UI.Views;

namespace Revit26_Plugin.RoofDetailLineIntersect.V011.Commands
{
    ...
    public class RoofDetailLineIntersectCommand : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            // ── Launch window ────────────────────────────────────────────────
            var vm     = new RoofDetailLineIntersectViewModel(roof.Id, detailLineIds, roof.Name, doc.ActiveView?.Name);
