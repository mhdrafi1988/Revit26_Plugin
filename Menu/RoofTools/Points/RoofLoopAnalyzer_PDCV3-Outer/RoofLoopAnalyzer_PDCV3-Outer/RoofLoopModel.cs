...
namespace Revit26_Plugin.PDCV3.Models
{
    public class RoofLoopModel : INotifyPropertyChanged
    {
        ...
        // True when the loop (or any segment of it) contains a curved curve
        public bool HasCurvedSegments { get; set; }

        // Curved arc length within the loop, in mm (for display)
        public double CurvedLengthMm { get; set; }
