...
using System.Linq;
using Revit26_Plugin.CreateSectionsFromDetailLines.V07.Filters;
using Revit26_Plugin.CreateSectionsFromDetailLines.V07.Views.SectionFromLineDialog;
using Revit26_Plugin.CreateSectionsFromDetailLines.V07.ViewModels;
using Revit26_Plugin.CreateSectionsFromDetailLines.V07.Services.Orchestration;

namespace Revit26_Plugin.CreateSectionsFromDetailLines.V07.Commands
{
