...
using Revit26_Plugin.CreateSectionsFromDetailLines.V07.Enums;
using Revit26_Plugin.CreateSectionsFromDetailLines.V07.Models;
using Revit26_Plugin.CreateSectionsFromDetailLines.V07.Services.Execution;

namespace Revit26_Plugin.CreateSectionsFromDetailLines.V07.ViewModels
{
    /// <summary>
