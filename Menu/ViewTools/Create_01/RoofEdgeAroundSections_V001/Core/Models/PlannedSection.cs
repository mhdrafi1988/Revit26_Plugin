...
namespace Revit26_Plugin.RoofEdgeSections.V001
{
    ...
    /// AlreadyExists / NoEdgeFound rows (V001 does not support force-recreate/overwrite).
    /// </summary>
    public partial class PlannedSection : ObservableObject
    {
        ...
        /// <summary>Proposed section view name: "{RoofDisplayName}_{Direction}_Section".</summary>
        ...
        /// <summary>Inward-facing normal at EdgeMidpoint, used as the section view direction.</summary>
        ...
        /// <summary>Result of the plan-build pass: Ready / AlreadyExists / NoEdgeFound.</summary>
        ...
        public string StatusText => Status switch
        {
            ...
            PlannedSectionStatus.AlreadyExists => "Already Exists",
