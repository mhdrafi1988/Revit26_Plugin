...
namespace Revit26_Plugin.RoofDrainCalloutPlacing.V006.ExternalEvents
{
    /// <summary>
    ...
    public class RoofDrainCalloutRunHandler : IExternalEventHandler
    {
        ...
        public void Execute(UIApplication app)
        {
            ...
            try
            {
                ...
                double marginFeet = _viewModel.CalloutMarginMm / 304.8;
                double floorFeet = _viewModel.CalloutFloorMm / 304.8;
                        ...
                        foreach (var g in allGroups)
                        {
                            try
                            {
                                calloutService.PlaceReferenceCallout(
                                    doc, parentViewId, draftingViewId, g.Centroid, g.Points, marginFeet, floorFeet, duplicateToleranceFeet);
                                placedCount++;
