// File: Services/SectionSortingService.cs
...
namespace Revit26_Plugin.APUS_V330.Services
{
    public static class SectionSortingService
    {
            ...
            double yToleranceMm)
        {
                ...
                .OrderByDescending(g => g.Key))
            {
                result.AddRange(group
                    .OrderByDescending(s => GetViewHeight(s.Item.View))
                    .ThenBy(s => s.X));
            }
        ...
        private static double GetViewHeight(ViewSection view)
        {
            ...
            {
                var bb = view.CropBox;
                return bb != null ? bb.Max.Y - bb.Min.Y : 0;
            }
            catch { return 0; }
        }
