...
namespace Revit26_Plugin.ParaManager.V001.Models
{
    ...
    /// <summary>Comparer so SharedParameterInfo can be deduplicated/looked-up by GUID.</summary>
    public class SharedParameterInfoGuidComparer : IEqualityComparer<SharedParameterInfo>
    {
        public bool Equals(SharedParameterInfo x, SharedParameterInfo y)
            => x != null && y != null && x.Guid == y.Guid;

        public int GetHashCode(SharedParameterInfo obj) => obj.Guid?.GetHashCode() ?? 0;
    }
}
