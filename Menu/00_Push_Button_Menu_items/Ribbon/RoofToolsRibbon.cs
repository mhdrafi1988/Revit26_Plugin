...
namespace Revit26_Plugin.Menu.Ribbon
{
    public static class RoofToolsRibbon
    {
        public static void Build(UIControlledApplication app, string tabName, string assemblyPath)
        {
            ...
            {
                new PushButtonData("Btn_AutoSlopeByPoint_028", "Auto Slope By Point", assemblyPath, "Revit26_Plugin.AutoSlopeByPoint.V028.Commands.AutoSlopeCommand")
                {
                    Image = ImageUtils.Load("Revit26_Plugin.Resources.Icons.RoofTools.by_point.png")
                },
                new PushButtonData("Btn_AutoSlopeByPoint_028_KdTree", "Auto Slope By Point (KD-Tree)", assemblyPath, "Revit26_Plugin.AutoSlopeByPointKdTree.VKD01.Commands.AutoSlopeCommand")
                {
                    Image = ImageUtils.Load("Revit26_Plugin.Resources.Icons.RoofTools.AutoSlopeByPoint_KdTree_32.png")
                },
                new PushButtonData("Btn_AutoSlopeByPointRidge_001", "Auto Slope By Point (Ridge)", assemblyPath, "Revit26_Plugin.AutoSlopeByPointRidge.V001.Commands.AutoSlopeCommand")
                {
                ...
                new PushButtonData("Btn_AutoSlopeByDrain_V007", "Auto Slope By Drain", assemblyPath, "Revit26_Plugin.AutoSlopeByDrain.V007.Commands.AutoSlopeByDrain")
                {
                    Image = ImageUtils.Load("Revit26_Plugin.Resources.Icons.RoofTools.by_drain.png")
                },
                new PushButtonData("Btn_AutoSlopeByDrain_V008", "Auto Slope By Drain (Multi-Roof)", assemblyPath, "Revit26_Plugin.MultiRoofSlopeByDrain.Commands.AutoSlopeByDrain")
                {
            ...
            {
                new PushButtonData("Btn_InnerLoopDivider_V009", "Divide Inner Loops", assemblyPath, "Revit26_Plugin.InnerLoopDivider.V009.Commands.InnerLoopDividerCommand")
                {
                    Image = ImageUtils.Load("Revit26_Plugin.Resources.Icons.RoofTools.InnerLoopDivider_32.png")
                },
                new PushButtonData("Btn_OuterCurveDivider_V004", "Outer Curve Divider", assemblyPath, "Revit26_Plugin.OuterCurveDivider.V004.Commands.CurveDividerCommand")
                {
                    Image = ImageUtils.Load("Revit26_Plugin.Resources.Icons.RoofTools.OuterCurveDivider_32.png")
                },
                new PushButtonData("Btn_RoofDetailLineIntersect_V012", "Roof Detail Line Intersect", assemblyPath, "Revit26_Plugin.RoofDetailLineIntersect.V012.Commands.RoofDetailLineIntersectCommand")
                {
                    Image = ImageUtils.Load("Revit26_Plugin.Resources.Icons.RoofTools.DetailLineIntersect_32.png")
                },
                new PushButtonData("Btn_InnerLoopsAndPerpendicular_V005", "Inner Loops And Perpendicular", assemblyPath, "Revit26_Plugin.InnerLoopsAndPerpendicular.V005.Commands.InnerLoopsAndPerpendicularCommand")
                {
                    Image = ImageUtils.Load("Revit26_Plugin.Resources.Icons.RoofTools.InnerLoopsPerpendicular_32.png")
                },
                new PushButtonData("Btn_VertexReducer_V007", "Roof Edge Vertex Reducer", assemblyPath, "Revit26_Plugin.RoofEdgeVertexReducer.V007.Commands.RoofEdgeVertexReducerCommand")
                {
                    Image = ImageUtils.Load("Revit26_Plugin.Resources.Icons.RoofTools.VertexReducer_32.png")
                },
                new PushButtonData("Btn_MultiplePoints_V001", "Multiple Points (1/2–1/4)", assemblyPath, "Revit26_Plugin.MultiplePoints.V001.Commands.MultiplePointsCommand")
                {
            ...
            {
                new PushButtonData("Btn_RoofRidgeLines_V57", "Roof Ridge Lines (By Points)", assemblyPath, "Revit26_Plugin.RoofTools.LineAndPoints.RoofRidgeLines.V057.Commands.RoofRidgeCommand")
                {
                    Image = ImageUtils.Load("Revit26_Plugin.Resources.Icons.RoofTools.RidgeLinesByPoints_32.png")
                },
                new PushButtonData("Btn_RoofRidgeLines_V68", "Roof Ridge Lines (Multiple Shapes)", assemblyPath, "Revit26_Plugin.RoofRidgeLines.V068.Commands.RoofRidgeCommand")
                {
            ...
            {
                new PushButtonData("Btn_RoofPointComparison_V001", "Roof Point Comparison", assemblyPath, "Revit26_Plugin.RoofPointComparison.V001.Commands.RoofComparisonCommand")
                {
                    Image = ImageUtils.Load("Revit26_Plugin.Resources.Icons.RoofTools.PointComparison_32.png")
                },
                new PushButtonData("Btn_RoofPointElevationSync_V001", "Roof Point Elevation Sync", assemblyPath, "Revit26_Plugin.RoofPointElevationSync.V002.Command")
                {
