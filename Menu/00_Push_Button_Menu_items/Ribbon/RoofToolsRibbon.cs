...
namespace Revit26_Plugin.Menu.Ribbon
{
    public static class RoofToolsRibbon
    {
        public static void Build(UIControlledApplication app, string tabName, string assemblyPath)
        {
            ...
            // Slope — every version is its own push button (no pulldowns), each
            // with an icon and a text label. Versions without a dedicated icon
            // reuse their tool family's icon.
            ...
            {
                new PushButtonData("Btn_AutoSlopeByPoint_028", "By Point V028", assemblyPath, "Revit26_Plugin.AutoSlopeByPoint.V028.Commands.AutoSlopeCommand")
                {
                    Image = ImageUtils.Load("Revit26_Plugin.Resources.Icons.RoofTools.by_point_16.png"),
                    ToolTip = "Auto Slope By Point (V028)"
                },
                ...
                new PushButtonData("Btn_AutoSlopeByPoint_MultiCopies28", "By Point Multi Copies", assemblyPath, "Revit26_Plugin.AutoSlopeByPoint.MultiCopies28.Commands.AutoSlopeCommand")
                {
                    Image = ImageUtils.Load("Revit26_Plugin.Resources.Icons.RoofTools.by_point_16.png"),
                    ToolTip = "Auto Slope By Point (Multi Copies, V028 base)"
                },
                new PushButtonData("Btn_AutoSlopeByDrain_V007", "By Drain V007", assemblyPath, "Revit26_Plugin.AutoSlopeByDrain.V007.Commands.AutoSlopeByDrain")
                {
                    Image = ImageUtils.Load("Revit26_Plugin.Resources.Icons.RoofTools.by_drain_16.png"),
                    ToolTip = "Auto Slope By Drain (V007)"
                },
                new PushButtonData("Btn_AutoSlopeByDrain_V008", "By Drain V008", assemblyPath, "Revit26_Plugin.MultiRoofSlopeByDrain.Commands.AutoSlopeByDrain")
                {
                    Image = ImageUtils.Load("Revit26_Plugin.Resources.Icons.RoofTools.AutoSlopeByDrain_MultiRoof_16.png"),
                    ToolTip = "Auto Slope By Drain (Multi-Roof) — V008"
                },
                new PushButtonData("Btn_AutoSlopeByDrain_V009", "By Drain V009", assemblyPath, "Revit26_Plugin.MultiRoofSlopeByDrain.V009.Commands.AutoSlopeByDrain")
                {
                    Image = ImageUtils.Load("Revit26_Plugin.Resources.Icons.RoofTools.AutoSlopeByDrain_MultiRoof_16.png"),
                    ToolTip = "Auto Slope By Drain (Multi-Roof) — V009"
                },
                new PushButtonData("Btn_AutoSlopeByDrain_V010", "By Drain V010", assemblyPath, "Revit26_Plugin.MultiRoofSlopeByDrain.V010.Commands.AutoSlopeByDrain")
                {
                    Image = ImageUtils.Load("Revit26_Plugin.Resources.Icons.RoofTools.AutoSlopeByDrain_MultiRoof_16.png"),
            ...
            // Line & Point — both versions are their own push buttons.
            ...
            {
                new PushButtonData("Btn_RoofRidgeLines_V68", "Ridge Multi Shapes V068", assemblyPath, "Revit26_Plugin.RoofRidgeLines.V068.Commands.RoofRidgeCommand")
                {
                    Image = ImageUtils.Load("Revit26_Plugin.Resources.Icons.RoofTools.RidgeLinesMultiShape_16.png"),
                    ToolTip = "Roof Ridge Lines (Multiple Shapes, V068)"
                },
                new PushButtonData("Btn_RoofRidgeLines_V57", "Ridge By Points V057", assemblyPath, "Revit26_Plugin.RoofTools.LineAndPoints.RoofRidgeLines.V057.Commands.RoofRidgeCommand")
                {
                    Image = ImageUtils.Load("Revit26_Plugin.Resources.Icons.RoofTools.RidgeLinesByPoints_16.png"),
                    ToolTip = "Roof Ridge Lines (By Points, V057)"
                },
            });
