    ...
    public static class ViewToolsRibbon
    {
        public static void Build(UIControlledApplication app, string tabName, string assemblyPath)
        {
            ...
            RibbonLayoutHelper.AddStackedButtons(createPanel, new List<RibbonItemData>
            {
                ...
                new PushButtonData("Btn_RoofEdgeAroundSections_V005", "Edge Around V005", assemblyPath, "Revit26_Plugin.RoofEdgeAroundSections.V005.RoofEdgeAroundSectionsCommand")
                {
            ...
            RibbonLayoutHelper.AddStackedButtons(renamePanel, new List<RibbonItemData>
            {
                ...
                new PushButtonData("Btn_ViewAutoRenamer_V003", "View Renamer V003", assemblyPath, "Revit26_Plugin.ViewAutoRenamer.V003.Commands.OpenViewAutoRenamerCommand")
                {
