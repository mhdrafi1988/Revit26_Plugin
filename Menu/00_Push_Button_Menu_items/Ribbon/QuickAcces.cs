...
namespace Revit26_Plugin.Menu.Ribbon
{
    public static class QuickAccessRibbon
    {
        ...
        public static void Build(UIControlledApplication app, string tabName, string assemblyPath)
        {
            ...
            PushButton auto_slope_button = panel.AddItem(new PushButtonData("Btn_AutoSlopeByPoint_25 QA", "Auto Slope Point 25 QA #", assemblyPath, "Revit26_Plugin.AutoSlopeByPoint.V025.Commands.AutoSlopeCommand")) as PushButton;
