...
namespace Revit26_Plugin.Menu.Ribbon
{
    public static class QuickAccessRibbon
    {
        ...
        public static void Build(UIControlledApplication app, string tabName, string assemblyPath)
        {
            ...
            PushButton auto_slope_V6_button = panel.AddItem(new PushButtonData("Btn_RoofRidgeLines_Q51", "Auto Ridge Creator 01", assemblyPath, "Revit26_Plugin.RoofTools.LineAndPoints.RoofRidgeLines_V51.Commands.RoofRidgeCommand")) as PushButton;
