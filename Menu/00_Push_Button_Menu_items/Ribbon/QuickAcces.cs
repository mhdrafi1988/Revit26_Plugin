...
namespace Revit26_Plugin.Menu.Ribbon
{
    public static class QuickAccessRibbon
    {
        ...
        public static void Build(UIControlledApplication app, string tabName, string assemblyPath)
        {
            ...
            PushButton auto_slope_button = panel.AddItem(new PushButtonData("Btn_AutoSlopeByPoint_05", "Auto Slope Point V0009", assemblyPath, "Revit26_Plugin.AutoSlopeByPoint.V009.Commands.AutoSlopeCommand")) as PushButton;
