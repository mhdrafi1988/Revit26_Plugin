...
{
    /// <summary>
    /// Geometry helpers for RoofTag V006.
    /// Partial class — leader logic in RoofTagGeometryHelper_Leader.cs
    ///                  vertex logic in RoofTagGeometryHelper_Vertices.cs
    ///                  view-space logic in RoofTagGeometryHelper_ViewSpace.cs
    ///                  collision logic in RoofTagGeometryHelper_Collision.cs
    /// </summary>
            ...
            out XYZ       projectedPoint)
        {
            ...
            foreach (GeometryObject obj in geomElem)
            {
                ...
                foreach (Face face in solid.Faces)
                {
                    ...
                    // Only accept upward-facing faces (normal Z > 0.2)
                    XYZ normal;
