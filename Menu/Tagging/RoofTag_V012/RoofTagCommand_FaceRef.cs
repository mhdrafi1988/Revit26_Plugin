...
using Revit26_Plugin.RoofTag_V012.Helpers;
...
namespace Revit26_Plugin.RoofTag_V012
{
    ...
    public class RoofTagCommand : IExternalCommand
    {
            ...
            ElementSet          elements)
        {
            ...
            if (roof == null)
            {
                TaskDialog.Show("Roof Tag V012 (FaceRef)", "No roof selected.");
            ...
            {
                TaskDialog.Show("Roof Tag V012 (FaceRef)", "No valid points found.");
                return Result.Cancelled;
            }
            ...
            // ── 6. Place tags ─────────────────────────────────────────────
            using (Transaction tx = new Transaction(doc, "Place Roof Tags V012 (FaceRef)"))
            {
                tx.Start();
