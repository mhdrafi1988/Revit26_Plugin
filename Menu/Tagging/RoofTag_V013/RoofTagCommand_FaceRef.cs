...
using Revit26_Plugin.RoofTag_V013.Helpers;
using Revit26_Plugin.Shared.Models;
using System.Collections.Generic;
using System.Linq;

namespace Revit26_Plugin.RoofTag_V013
{
    ...
    public class RoofTagCommand : IExternalCommand
    {
            ...
            ElementSet          elements)
        {
            ...
            if (roof == null)
            {
                TaskDialog.Show("Roof Tag V013 (FaceRef)", "No roof selected.");
            ...
            {
                TaskDialog.Show("Roof Tag V013 (FaceRef)", "No valid points found.");
                return Result.Cancelled;
            }
            ...
            // ── 6. Place tags ─────────────────────────────────────────────
            using (Transaction tx = new Transaction(doc, "Place Roof Tags V013 (FaceRef)"))
            {
                tx.Start();
