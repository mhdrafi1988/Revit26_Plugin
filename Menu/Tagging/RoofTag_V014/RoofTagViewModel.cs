...
namespace Revit26_Plugin.RoofTag_V014
{
    public class RoofTagViewModel : ObservableObject, INotifyPropertyChanged
    {
        ...
        /// <summary>Rule 2 — when true, each interior loop is reduced to its top 4
        /// highest points (or fewer), collapsing to a single point if they aren't
        /// spaced far enough apart. Runs before Rule 1.</summary>
