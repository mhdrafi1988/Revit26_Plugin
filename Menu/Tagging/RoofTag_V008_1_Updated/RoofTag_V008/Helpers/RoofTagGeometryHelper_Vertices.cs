...
namespace Revit26_Plugin.RoofTag_V008.Helpers
{
    internal static partial class RoofTagGeometryHelper
    {
        /// <summary>
        /// Extract exact shape vertices from the roof's SlabShapeEditor.
        /// Groups vertices by XY position and returns the highest Z for each group.
        /// </summary>
        ...
        /// <summary>
        /// Build roof boundary as XY projection (Z=0).
        /// Used for spatial analysis and boundary checks.
        /// </summary>
