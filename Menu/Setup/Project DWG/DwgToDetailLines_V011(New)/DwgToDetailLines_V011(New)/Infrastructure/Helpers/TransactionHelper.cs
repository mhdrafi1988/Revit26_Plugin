...
// Layer: Infrastructure/Helpers
// ==============================================

using Autodesk.Revit.DB;
using System;

namespace Revit26_Plugin.DwgToDetailLines.V011.Infrastructure.Helpers
{
    /// <summary>
    /// Lightweight helper for safe transaction execution. A commit-time
    /// geometry failure (e.g. "Line is too short.") that Revit would
    /// otherwise show as a blocking "cannot be ignored" dialog is
    /// auto-resolved by deleting the offending element(s) instead — see
