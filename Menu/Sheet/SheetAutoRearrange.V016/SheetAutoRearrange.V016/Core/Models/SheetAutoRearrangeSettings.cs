namespace Revit26_Plugin.SheetAutoRearrange.V016.Core.Models
{
    ...
    ///
    /// V016 CHANGE: SheetOrderPackingService internals refactored —
    ...
    ///
    /// V016 CLEANUP (2): Confirmed-dead code removed outright —
    ...
    public class SheetAutoRearrangeSettings
    {
        ...
        /// <summary>V014 NEW — which of the three Master Row fill strategies to use. Default Shelf matches the prior system's general character (simplest, most predictable).</summary>
        public RowFillStrategy RowFillStrategy { get; set; } = RowFillStrategy.Shelf;
