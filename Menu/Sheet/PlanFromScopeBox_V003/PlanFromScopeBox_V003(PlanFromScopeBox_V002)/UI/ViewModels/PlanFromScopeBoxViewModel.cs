...
using Revit26_Plugin.PlanFromScopeBox.V003.Core.Engine;
using Revit26_Plugin.PlanFromScopeBox.V003.Core.Models;
using Revit26_Plugin.PlanFromScopeBox.V003.Core.Services;
using Revit26_Plugin.PlanFromScopeBox.V003.Infrastructure.ExternalEvents;
using Revit26_Plugin.PlanFromScopeBox.V003.Infrastructure.Helpers;
using Revit26_Plugin.PlanFromScopeBox.V003.Infrastructure.Settings;
using Revit26_Plugin.Shared.Models;

namespace Revit26_Plugin.PlanFromScopeBox.V003.UI.ViewModels
{
    /// <summary>
