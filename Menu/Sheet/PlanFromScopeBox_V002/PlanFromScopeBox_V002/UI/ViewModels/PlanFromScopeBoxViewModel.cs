...
using Revit26_Plugin.PlanFromScopeBox.V002.Core.Models;
using Revit26_Plugin.PlanFromScopeBox.V002.Core.Services;
using Revit26_Plugin.PlanFromScopeBox.V002.Infrastructure.ExternalEvents;
using Revit26_Plugin.PlanFromScopeBox.V002.Infrastructure.Helpers;
using Revit26_Plugin.PlanFromScopeBox.V002.Infrastructure.Settings;
using Revit26_Plugin.Shared.Models;

namespace Revit26_Plugin.PlanFromScopeBox.V002.UI.ViewModels
{
    /// <summary>
