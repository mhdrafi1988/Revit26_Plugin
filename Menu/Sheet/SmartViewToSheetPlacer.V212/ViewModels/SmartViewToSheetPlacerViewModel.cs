...
namespace Revit26_Plugin.SmartViewToSheetPlacer.V212.ViewModels
{
    ...
    ///
    /// V212: split into partial class files by stage for maintainability
    /// (was a single 732-line file in V212):
    ...
    public partial class SmartViewToSheetPlacerViewModel : ObservableObject
    {
        ...
        /// command leaves the window open now (V212).</summary>
        public event Action? CloseRequested;

        /// <summary>
        /// Called from the View's Window.Closing handler (V212 — new). Ensures
            ...
            _dispatcher.Invoke(() =>
            {
                ...
                switch (_handler.Request)
                {
                    ...
                    case SmartViewToSheetPlacerRequest.OpenSheets:
                        // V212 UPDATE: previously auto-closed the window here once
