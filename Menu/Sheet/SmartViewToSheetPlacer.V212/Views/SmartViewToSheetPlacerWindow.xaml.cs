...
using Revit26_Plugin.SmartViewToSheetPlacer.V212.ViewModels;

namespace Revit26_Plugin.SmartViewToSheetPlacer.V212.Views
{
    /// <summary>
    ...
    /// settings regardless of which path triggered the close (V212 — new).
    /// </summary>
    public partial class SmartViewToSheetPlacerWindow : Window
    {
        ...
        /// <summary>
        /// V212 — defensive fallback only. The primary SharedStyles.xaml merge
        ...
        /// <summary>
        /// V212 — new. Ensures settings are persisted on any window close path
