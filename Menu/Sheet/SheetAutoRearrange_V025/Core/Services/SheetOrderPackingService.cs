...
using Revit26_Plugin.SheetAutoRearrange.V025.Core.Models;
using System;
using System.Collections.Generic;
using System.Linq;

namespace Revit26_Plugin.SheetAutoRearrange.V025.Core.Services
{
    /// <summary>
    ...
    public class SheetOrderPackingService
    {
            ...
            BlockAlignmentH withinColumnAlign)
        {
            ...
            var flat = masterPlacements.Concat(laidOutBands.SelectMany(r => r)).ToList();
            if (flat.Count == 0)
                return results;
