...
namespace Revit26_Plugin.AutomatedSectionPlacer.V001.ViewModels
{
    ...
    public partial class AutomatedSectionPlacerViewModel
    {
        ...
        /// <summary>
        /// V213 fix: previously always returned "Not Started" unless
        ...
        /// <summary>
        /// V213: controls whether AutoSaveLogs() shows the folder-picker
        ...
        /// fields (Margins, Gap settings, etc.). V213 UPDATE: default changed
        ...
        /// <summary>
        /// V213 UPDATE: only affects sheets in currently-EXPANDED SheetTypeGroups
        ...
        /// <summary>
        /// V213 UPDATE: renamed from OpenSelectedAndClose — "Open Selected" and
        ...
        private void OpenSelected()
        {
            ...
            _handler.Request = AutomatedSectionPlacerRequest.OpenSheets;
            _event.Raise();
        }
        ...
        /// Logs button), per convention. V213: only shows the folder-picker
