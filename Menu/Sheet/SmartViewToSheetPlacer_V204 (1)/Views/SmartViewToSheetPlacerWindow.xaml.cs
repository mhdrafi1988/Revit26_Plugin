...
using Revit26_Plugin.SmartViewToSheetPlacer.V204.ViewModels;

namespace Revit26_Plugin.SmartViewToSheetPlacer.V204.Views
{
    /// <summary>
    ...
    /// settings regardless of which path triggered the close (V204 — new).
    /// </summary>
    public partial class SmartViewToSheetPlacerWindow : Window
    {
        ...
        /// <summary>
        /// V204 — defensive fallback only. The primary SharedStyles.xaml merge
        ...
        /// <summary>
        /// V204 — new. Ensures settings are persisted on any window close path
