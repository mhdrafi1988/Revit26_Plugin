...
namespace Revit26_Plugin.SmartViewToSheetPlacer.V222.Models
{
    /// <summary>
    ...
    public partial class SheetGroup : ObservableObject
    {
        ...
        /// </summary>
        public string DisplayLabel => $"Sheet {SheetIndex}: {GeneratedName}";
        ...
        /// default (SmartViewToSheetPlacerViewModel.Stage2's
